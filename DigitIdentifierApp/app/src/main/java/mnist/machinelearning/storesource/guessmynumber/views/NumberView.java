...
public class NumberView extends View {
    ...
    //create the Numberview, for a given length and width
    private void setup() {
        mSetuped = true;
    ...
    public void onDraw(Canvas canvas) {
        ...
        Drawer.renderModel(mOffscreenCanvas, mModel, mPaint, startIndex);
    ...
    /**
     * Convert screen position to match position on Bitmap
     */
    ...
    public float[] getPixelData() {
        ...
        for (int i = 0; i < pixels.length; ++i) {
            ...
            int pix = pixels[i];
            int b = pix & 0xff;// Set 0 for white and 255 for black pixels
